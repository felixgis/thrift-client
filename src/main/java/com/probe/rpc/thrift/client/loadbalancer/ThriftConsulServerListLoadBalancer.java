...
import com.probe.rpc.thrift.client.discovery.ServerListUpdater;
import com.probe.rpc.thrift.client.discovery.ThriftConsulServerListUpdater;
...
public class ThriftConsulServerListLoadBalancer extends AbstractLoadBalancer {
	...
	private void updateListOfServers() {
		Map<String, LinkedHashSet<ThriftConsulServerNode>> thriftConsulServers = this.serverNodeList
