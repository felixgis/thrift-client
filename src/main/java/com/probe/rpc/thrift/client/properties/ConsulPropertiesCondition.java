package com.probe.rpc.thrift.client.properties;
...
public class ConsulPropertiesCondition extends SpringBootCondition {
	...
	private static final String SPRING_CLOUD_CONSUL_HOST = "spring.consul.host";
	private static final String SPRING_CLOUD_CONSUL_PORT = "spring.consul.port";
