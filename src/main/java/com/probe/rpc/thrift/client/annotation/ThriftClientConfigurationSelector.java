package com.probe.rpc.thrift.client.annotation;

import com.google.common.collect.Sets;
import com.probe.rpc.thrift.client.ProbeFactoryImportSelector;
...
public class ThriftClientConfigurationSelector extends ProbeFactoryImportSelector<EnableThriftClient> {

	private static final Logger logger = LoggerFactory.getLogger(ThriftClientConfigurationSelector.class);

	private static final Set<String> SERVICE_MODEL_SET = Sets.newHashSet("simple", "nonBlocking", "threadPool", "hsHa",
			"threadedSelector");
