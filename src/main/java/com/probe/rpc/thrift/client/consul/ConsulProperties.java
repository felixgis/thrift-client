...
public class ConsulProperties {
	...
	public String toString() {
		return "ConsulProperties{" + "host='" + host + '\'' + ", port=" + port + ", scheme=" + scheme + ", tls=" + tls
				+ ", enabled=" + enabled + '}';
	}
	...
	public static class TLSConfig {
		...
		@Override
		public String toString() {
			return new ToStringCreator(this).append("keyStoreInstanceType", keyStoreInstanceType)
					.append("keyStorePath", keyStorePath).append("keyStorePassword", keyStorePassword)
					.append("certificatePath", certificatePath).append("certificatePassword", certificatePassword)
					.toString();
		}
	}
}
